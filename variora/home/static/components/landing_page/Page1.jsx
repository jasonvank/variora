...
const page1Data = [
  {
    ...
    name: 'Innovation',
    nameEn: 'Catch every moment when you have innovative ideas',
    svgBg: (
  ...
  },
  {
    ...
    name: 'Visualisation',
    nameEn: 'Visualize your idea using annotations, comments and graphs',
    svgBg: (
  ...
  },
  {
    ...
    name: 'Teamwork',
    nameEn: 'Classify the documentations in different groups',
    svgBg: (
    ...
    const children = page1Data.map((item, i) => {
      ...
      return (
        <Col key={item.nameEn} md={6} xs={24}>
          ...
          >
            {(isHover) && this.getSvgChild(item.svgBg.props.children)}
          </TweenOneGroup>
          <QueueAnim
